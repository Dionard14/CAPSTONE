...
<body>
 ...
 <div class="modal fade" id="loginadmin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <form action="process.php" method="POST"> <!-- Opening <form> tag here -->
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="email" class="form-control" name="log_email" id="adminEmail" placeholder="Enter email here..." required>
  ...
  <div class="modal fade" id="createteacher" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Register an Account</h5>
      ...
      <form action="process.php" method="POST"> <!-- Opening <form> tag here -->
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="email" class="form-control" name="log_email" id="studentEmail" placeholder="Enter email here..." required>
            <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
          </div>
          <div class="mb-3">
        ...
        <form action="process.php" method="POST"> <!-- Opening <form> tag here -->
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="email" class="form-control" name="log_email" id="teacherEmail" placeholder="Enter email here..." required>
              <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
            </div>
            <div class="mb-3">
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <p> The PHINMA-University of Iloilo is a private, nonsectarian, coeducational institution in Iloilo City, Philippines. It was established in 1947 by the López family of
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="150">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-entrance">
            ...
            <div class="portfolio-info">
              <h4>ENTRANCE</h4>
              <a href="assets/img/portfolio/ENT.png" style="text-align: center;"data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="ENTRANCE"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-entrance">
            ...
            <div class="portfolio-info">
              <h4>ENTRANCE</h4>
              <a href="assets/img/portfolio/ENT2.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="ENTRANCE"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-filipiniana">
            ...
            <div class="portfolio-info">
              <h4>FILIPINIANA</h4>
              <a href="assets/img/portfolio/FIL.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="FILIPINIANA"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-filipiniana">
            ...
            <div class="portfolio-info">
              <h4>FILIPINIANA</h4>
              <a href="assets/img/portfolio/FIL1.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="FILIPINIANA"><i class="bx bx-plus"></i></a>
              <a href="fil.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grad">
            ...
            <div class="portfolio-info">
              <h4>GRAD</h4>
              <a href="assets/img/portfolio/GS.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="GRADUATE SCHOOL"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grad">
            ...
            <div class="portfolio-info">
              <h4>GRAD</h4>
              <a href="assets/img/portfolio/GS2.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="GRADUATE SCHOOL"><i class="bx bx-plus"></i></a>
              <a href="grad.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grs">
            ...
            <div class="portfolio-info">
              ...
              <a href="assets/img/portfolio/GRS.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="GENERAL REFERENCE SECTION"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grs">
            ...
            <div class="portfolio-info">
              <h4>GENERAL REFERENCE</h4>
              <a href="assets/img/portfolio/GRS1.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="GENERAL REFERENCE SECTION"><i class="bx bx-plus"></i></a>
              <a href="grs.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cs">
            ...
            <div class="portfolio-info">
              ...
              <a href="assets/img/portfolio/CS.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="CIRCULATION SECTION"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cs">
            ...
            <div class="portfolio-info">
              <h4>CIRCULATION SECTION</h4>
              <a href="assets/img/portfolio/CS1.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="CIRCULATION SECTION"><i class="bx bx-plus"></i></a>
              <a href="cs.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="assets/img/team/leonore.png" alt="">
          ...
          <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="assets/img/team/wilma.png" alt="">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-3 col-md-3 col-sm-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="assets/img/team/hope.png" alt="">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="assets/img/team/wei.png" alt="">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="assets/img/team/ara.png" alt="">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="assets/img/team/jen.png" alt="">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-12">
            <iframe class="mb-4 mb-lg-0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1283.3758354694248!2d122.56946369831327!3d10.692253457150182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33aee5255345f11b%3A0xb32057bb6b1d39c8!2sPHINMA%20UNIVERSITY%20OF%20ILOILO!5e0!3m2!1sen!2sph!4v1695219855025!5m2!1sen!2sph" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
          </div>
